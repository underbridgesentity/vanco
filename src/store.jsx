...
export const SEED = {
  ...
  fans: [
    { id: "f1", name: "Thandi M.", email: "thandi@mail.com", country: "South Africa", interests: ["Tour alerts", "New music"], date: "2026-05-31" },
    { id: "f2", name: "Marco R.", email: "marco@mail.it", country: "Italy", interests: ["Exclusive mixes", "Tour alerts"], date: "2026-05-31" },
    { id: "f3", name: "Yuki T.", email: "yuki@mail.jp", country: "Japan", interests: ["New music", "Merch"], date: "2026-05-30" },
    { id: "f4", name: "Sara K.", email: "sara@mail.ae", country: "UAE", interests: ["Tour alerts"], date: "2026-05-30" },
    { id: "f5", name: "Liam O.", email: "liam@mail.uk", country: "UK", interests: ["Exclusive mixes", "New music", "Tour alerts"], date: "2026-05-29" },
    { id: "f6", name: "Naledi P.", email: "naledi@mail.com", country: "South Africa", interests: ["New music"], date: "2026-05-29" },
    { id: "f7", name: "Diego F.", email: "diego@mail.mx", country: "Mexico", interests: ["Tour alerts", "Merch"], date: "2026-05-28" },
    { id: "f8", name: "Amara N.", email: "amara@mail.ng", country: "Nigeria", interests: ["New music", "Exclusive mixes"], date: "2026-05-28" },
  ],
  guestlist: [
